                        ...
                        set_content = &adw::ToastOverlay {
                            ...
                            set_child = &adw::PreferencesPage {
                                add = &adw::PreferencesGroup {
                                    set_title: &i18n("Cloud storage"),
                                    set_description: Some(&i18n("Connect your cloud storage provider to upload and share large files instead of an attachment. A cloud icon appears in the compose toolbar once a provider is added. Supported providers: Nextcloud, ownCloud, OpenCloud, OneDrive, Dropbox and Seafile.")),
