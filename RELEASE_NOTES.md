...
**Swipe a message to archive or delete it.** Drag a row sideways with the mouse, or swipe it with two fingers on a trackpad: left deletes, right archives, and a coloured strip under the row names the action as you go. Swap the two in Settings if you prefer. Contributed by [Isaac](https://github.com/thecalamityjoe87) (#135), answering [@taprobane99](https://github.com/taprobane99)'s request (#92).
